...
import 'workspace_markdown_editor.dart';
import '../../theme/app_colors.dart';

/// Main document editor area with optional sidebar (supports PDF and Markdown)
class WorkspaceDocumentEditor extends StatefulWidget {
  final DocumentTabManager tabManager;

  const WorkspaceDocumentEditor({super.key, required this.tabManager});
        ...
        content: SizedBox(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              if (tab == activeTab || !tab.isPdf) return const SizedBox.shrink();
  ...
  Widget build(BuildContext context) {
    return ListenableBuilder(
      ...
      builder: (context, _) {
        ...
        // Show markdown editor for markdown files
        if (activeTab.isMarkdown) {
          return WorkspaceMarkdownEditor(file: activeTab.file);
        }

        // PDF view with split view support
        if (_isSplitView && activeTab.isPdf) {
      ...
      child: Center(
        child: Column(
          ...
          children: [
            ...
            Text(
              'Open a PDF or Markdown file from the explorer',
              style: TextStyle(
...
typedef WorkspacePdfEditor = WorkspaceDocumentEditor;
