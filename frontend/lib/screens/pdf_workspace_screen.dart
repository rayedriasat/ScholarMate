...
class _PdfWorkspaceScreenState extends State<PdfWorkspaceScreen> {
  late PdfTabManager _tabManager;
  ...
  void _toggleAiChat() {
    setState(() {
      ...
      if (_showAiChat) {
        _showExplorer =
            false; // Close explorer when opening chat on small screens
      }
    });
  }
